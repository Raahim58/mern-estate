...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountPrice) return setError('Discounted price should be lower than Regular price');
            setLoading(true);
            setError(false);
    ...
    return (
        ...
        <h1 className='text-3xl text-gray-700 font-semibold text-center my-7' style={{ fontFamily: 'Monaco, Times, monospace'}}>List your property!</h1>
            <form onSubmit = {handleSubmit} className='sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4 my-6'>
                    ...
                    style={{ fontFamily: 'Monaco, Times, monospace'}}>{loading ? 'Creating...' : 'Create Listing'} </button>
